...
## Container - display (내부 display 요소) <a id="in_display">#</a>
...
## Container - flex–wrap
- 요소들이 강제로 한줄에 배치되게 할 것인지, 또는 가능한 영역 내에서 벗어나지 않고 여러행으로 나누어 표현 할 것인지 결정하는 속성입니다. 
...
```
출처 : https://flexboxfroggy.com/#ko 16단계  
